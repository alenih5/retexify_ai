...
// Neue intelligente Keyword-Research-Engine einbinden
$intelligent_files = array(
    'includes/class-api-manager.php',
    'includes/class-intelligent-keyword-research.php'
);

foreach ($intelligent_files as $file) {
    $file_path = RETEXIFY_PLUGIN_PATH . $file;
    if (file_exists($file_path)) {
        require_once $file_path;
    } else {
        error_log('ReTexify AI: Intelligent feature file missing: ' . $file);
    }
}
...
class ReTexify_AI_Pro_Universal {
    ...
    public function admin_page() {
        ...
        $this->render_intelligent_research_status();
        ?>
        <?php
    }
